...
- Default pinned version: `v0.47.0`
...
- **Release (default):** Uses `google-gemini/gemini-cli@v0.47.0` and exposes `packages.default`.
- **Stable tag (`v0.47.0`):** Uses the `gemini-cli-stable-src` input and exposes `packages.stable`.
